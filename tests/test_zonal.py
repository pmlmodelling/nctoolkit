...
class TestClip(unittest.TestCase):
    ...
    def test_zonal1(self):
        ...
        if cdo_version() != "1.9.3":
            ...
            assert data.to_dataframe().sst[0].values[0].astype("float") == 17.550796508789062
        ...
        if cdo_version() != "1.9.3":
            ...
            assert data.to_dataframe().sst[0].values[0].astype("float") == 13.19469928741455
        ...
        if cdo_version() != "1.9.3":
            ...
            assert data.to_dataframe().sst[0].values[0].astype("float") == 20.55091094970703
        ...
        if cdo_version() != "1.9.3":
            ...
            assert data.to_dataframe().sst[0].values[0].astype("float") == 7.345167636871338
